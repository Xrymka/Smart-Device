...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_send_form__WEBPACK_IMPORTED_MODULE_6__["initForm"])();
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function close() {
      ...
      var modalName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._modalName;
      var modal = document.querySelector("[data-modal=\"".concat(modalName, "\"]"));
      var formModal = modal.querySelector('[data-form="form"]');
      document.removeEventListener('click', this._documentClickHandler);
      if (!modal || !modal.classList.contains('is-active')) {
        return;
      }
...
var buttonMore = document.querySelector('[data-company="btn-more"]');
var textExtended = document.querySelector('[data-company="text"]');
