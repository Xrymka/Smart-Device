...
/* harmony import */ var _modules_more_btn__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/more-btn */ "./js/modules/more-btn.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_more_btn__WEBPACK_IMPORTED_MODULE_4__["initShowText"])();
  Object(_modules_phone_mask__WEBPACK_IMPORTED_MODULE_5__["initPhoneMask"])();
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_3__["initAccordion"])();
  Object(_modules_reset_form__WEBPACK_IMPORTED_MODULE_6__["resetDefaultForm"])(form);
...
var accordionTitles = document.querySelectorAll('[data-footer="accordion"]');
var accordionHandler = function accordionHandler(item) {
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    key: "_modalSubmitHandler",
    value: function _modalSubmitHandler(evt) {
      var formModal = document.querySelector('[data-modal="form"]');
      if (formModal) {
        evt.preventDefault();
        this.close(document.querySelector('.modal.is-active').dataset.modal);
      }
    ...
    value: function close() {
      ...
      var modalName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._modalName;
      var modal = document.querySelector("[data-modal=\"".concat(modalName, "\"]"));
      var formModal = modal.querySelector('[data-modal="form"]');
      document.removeEventListener('click', this._documentClickHandler);
      if (!modal || !modal.classList.contains('is-active')) {
        return;
      }
...
var buttonMore = document.querySelector('[data-company="more"]');
var textMore = document.querySelector('[data-company="text"]');
